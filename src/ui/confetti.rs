...
fn cell_empty(grid: &Vec<Vec<Cell>>, row: usize, col: usize) -> bool {
...
fn swap_cells(grid: &mut Vec<Vec<Cell>>, row1: usize, col1: usize, row2: usize, col2: usize) {
    if row1 == row2 {
...
fn place_center_text(grid: &mut Vec<Vec<Cell>>, text: &str, color: Color) {
